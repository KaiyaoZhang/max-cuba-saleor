...
def test_order_products_on_percentage_promotion_CORE_2103(
    ...
    unit_discount = round(product_price * discount_value / 100, 2)
    assert unit_discount == order_line["unitDiscount"]["amount"]
    ...
    product_discounted_price = product_price - unit_discount
